...
- **Inbound delivery ledger:** Per-KF message state that recovers messages claimed before a prior process stopped.
...
- **WeCom authorization:** `appSecret` belongs to a self-built WeCom app authorized for the customer-service account in WeChat KF Admin.
